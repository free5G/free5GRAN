...
namespace free5GRAN {
    namespace phy {
        namespace transport_channel {
            ...
            // To be deleted void rate_matching_polar_coding(int *polar_encode_bch, int *rate_matched_bch);
            void rate_matching_polar_coding(vector<int> polar_encode_bch_vector, vector<int> &rate_matched_bch_vector);
            // To be deleted void bch_encoding(int * mib_bits, int pci, int N, int * rate_matched_bch);
