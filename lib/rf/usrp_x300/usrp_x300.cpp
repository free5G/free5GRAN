...
free5GRAN::usrp_x300::usrp_x300(double sample_rate, double center_frequency, double gain, double bandwidth, free5GRAN::rf_device chosen_device) : rf() {
    /**
     * \fn usrp_x300
    ...
    */
    ...
    device_args += ", master_clock_rate=184.32e6, recv_frame_size=7972, send_frame_size=7972";
    string subdev;
...
double free5GRAN::usrp_x300::getSampleRate() {
    /**
     * \fn getSampleRate
 ...
 */
void free5GRAN::usrp_x300::get_samples(vector<complex<float>> &buff, double &time_first_sample) {
    /**
     * \fn get_samples
...
double free5GRAN::usrp_x300::getCenterFrequency() {
    /**
...
double free5GRAN::usrp_x300::getGain() {
    /**
     * \fn getGain
