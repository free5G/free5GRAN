...
void free5GRAN::utils::common_utils::display_vector_2D_int(std::vector<std::vector<int>> vector_to_display, int vector_size1, int vector_size2, int line_break,
                                                       char *vector_name){
    /**
    * \fn display_vector2D (std::vector<std::vector<int>> *vector_to_display, int vector_size1, int vector_size2, char* vector_name)
    * \brief Displays a vector<vector<int>> in the console.
    *
    * \param[in] vector_to_display
    * \param[in] vector_size1 number of vector in the vector_to_display
