...
asn_TYPE_member_t asn_MBR_CGI_InfoNR_1[] = {
	{ ATF_POINTER, 4, offsetof(struct CGI_InfoNR, plmn_IdentityInfoList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct CGI_InfoNR, frequencyBandList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct CGI_InfoNR, noSIB1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_noSIB1_4,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct CGI_InfoNR, npn_IdentityInfoList_r16),
...
static const int asn_MAP_CGI_InfoNR_oms_1[] = { 0, 1, 2, 3 };
