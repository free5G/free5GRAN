...
asn_TYPE_member_t asn_MBR_SIB9_1[] = {
	{ ATF_POINTER, 3, offsetof(struct SIB9, timeInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_timeInfo_2,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SIB9, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SIB9, referenceTimeInfo_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_SIB9_oms_1[] = { 0, 1, 2 };
