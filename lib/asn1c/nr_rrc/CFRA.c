...
static asn_oer_constraints_t asn_OER_memb_totalNumberOfRA_Preambles_constr_23 CC_NOTUSED = {
	{ 1, 1 }	/* (1..63) */,
	-1};
static asn_per_constraints_t asn_PER_memb_totalNumberOfRA_Preambles_constr_23 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_CFRA_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CFRA, totalNumberOfRA_Preambles),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_totalNumberOfRA_Preambles_constr_23, &asn_PER_memb_totalNumberOfRA_Preambles_constr_23,  memb_totalNumberOfRA_Preambles_constraint_1 },
		0, 0, /* No default value */
