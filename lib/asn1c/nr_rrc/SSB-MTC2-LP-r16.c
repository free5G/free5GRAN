...
static asn_SET_OF_specifics_t asn_SPC_pci_List_specs_2 = {
	sizeof(struct SSB_MTC2_LP_r16__pci_List),
	offsetof(struct SSB_MTC2_LP_r16__pci_List, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SSB_MTC2_LP_r16_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SSB_MTC2_LP_r16, pci_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_pci_List_2,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC2_LP_r16, periodicity),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static const int asn_MAP_SSB_MTC2_LP_r16_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_SSB_MTC2_LP_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SSB_MTC2_LP_r16_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pci-List */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* periodicity */
};
asn_SEQUENCE_specifics_t asn_SPC_SSB_MTC2_LP_r16_specs_1 = {
	sizeof(struct SSB_MTC2_LP_r16),
	offsetof(struct SSB_MTC2_LP_r16, _asn_ctx),
	asn_MAP_SSB_MTC2_LP_r16_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_SSB_MTC2_LP_r16_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SSB_MTC2_LP_r16 = {
	"SSB-MTC2-LP-r16",
	"SSB-MTC2-LP-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_SSB_MTC2_LP_r16_tags_1,
	sizeof(asn_DEF_SSB_MTC2_LP_r16_tags_1)
		/sizeof(asn_DEF_SSB_MTC2_LP_r16_tags_1[0]), /* 1 */
	asn_DEF_SSB_MTC2_LP_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_SSB_MTC2_LP_r16_tags_1)
		/sizeof(asn_DEF_SSB_MTC2_LP_r16_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_SSB_MTC2_LP_r16_1,
	2,	/* Elements count */
	&asn_SPC_SSB_MTC2_LP_r16_specs_1	/* Additional specs */
};
