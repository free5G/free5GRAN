 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_lcp_RestrictionSidelink_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_multipleConfiguredGrantsSidelink_r16_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_lcp_RestrictionSidelink_r16_2 = {
	...
	{ &asn_OER_type_lcp_RestrictionSidelink_r16_constr_2, &asn_PER_type_lcp_RestrictionSidelink_r16_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_multipleConfiguredGrantsSidelink_r16_4 = {
	...
	{ &asn_OER_type_multipleConfiguredGrantsSidelink_r16_constr_4, &asn_PER_type_multipleConfiguredGrantsSidelink_r16_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_MAC_ParametersSidelinkCommon_r16_1[] = {
	{ ATF_POINTER, 2, offsetof(struct MAC_ParametersSidelinkCommon_r16, lcp_RestrictionSidelink_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_ParametersSidelinkCommon_r16, multipleConfiguredGrantsSidelink_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_MAC_ParametersSidelinkCommon_r16_oms_1[] = { 0, 1 };
