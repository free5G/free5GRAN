...
asn_TYPE_member_t asn_MBR_PeriodicalReportConfigInterRAT_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfigInterRAT, reportQuantityUTRA_FDD_r16),
...
static const int asn_MAP_PeriodicalReportConfigInterRAT_oms_1[] = { 4 };
...
asn_SEQUENCE_specifics_t asn_SPC_PeriodicalReportConfigInterRAT_specs_1 = {
	...
	asn_MAP_PeriodicalReportConfigInterRAT_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
