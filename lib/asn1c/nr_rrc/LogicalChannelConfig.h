...
typedef enum LogicalChannelConfig__ul_SpecificParameters__allowedPHY_PriorityIndex_r16 {
	LogicalChannelConfig__ul_SpecificParameters__allowedPHY_PriorityIndex_r16_p0	= 0,
	LogicalChannelConfig__ul_SpecificParameters__allowedPHY_PriorityIndex_r16_p1	= 1
} e_LogicalChannelConfig__ul_SpecificParameters__allowedPHY_PriorityIndex_r16;
typedef enum LogicalChannelConfig__bitRateMultiplier_r16 {
	LogicalChannelConfig__bitRateMultiplier_r16_x40	= 0,
	LogicalChannelConfig__bitRateMultiplier_r16_x70	= 1,
	LogicalChannelConfig__bitRateMultiplier_r16_x100	= 2,
	LogicalChannelConfig__bitRateMultiplier_r16_x200	= 3
} e_LogicalChannelConfig__bitRateMultiplier_r16;
...
typedef struct LogicalChannelConfig {
	struct LogicalChannelConfig__ul_SpecificParameters {
		...
		struct LogicalChannelConfig__ul_SpecificParameters__allowedCG_List_r16 {
			A_SEQUENCE_OF(ConfiguredGrantConfigIndexMAC_r16_t) list;
...
/* extern asn_TYPE_descriptor_t asn_DEF_allowedPHY_PriorityIndex_r16_69;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_bitRateMultiplier_r16_74;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LogicalChannelConfig_1[3];
