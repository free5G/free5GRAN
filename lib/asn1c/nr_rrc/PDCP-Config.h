...
typedef enum PDCP_Config__discardTimerExt_r16_PR {
	PDCP_Config__discardTimerExt_r16_PR_NOTHING,	/* No components present */
	PDCP_Config__discardTimerExt_r16_PR_release,
	PDCP_Config__discardTimerExt_r16_PR_setup
} PDCP_Config__discardTimerExt_r16_PR;
typedef enum PDCP_Config__ethernetHeaderCompression_r16_PR {
	PDCP_Config__ethernetHeaderCompression_r16_PR_NOTHING,	/* No components present */
	PDCP_Config__ethernetHeaderCompression_r16_PR_release,
	PDCP_Config__ethernetHeaderCompression_r16_PR_setup
} PDCP_Config__ethernetHeaderCompression_r16_PR;
...
typedef struct PDCP_Config {
	...
	struct PDCP_Config__discardTimerExt_r16 {
		PDCP_Config__discardTimerExt_r16_PR present;
		union PDCP_Config__discardTimerExt_r16_u {
			NULL_t	 release;
	...
	struct PDCP_Config__moreThanTwoRLC_DRB_r16 {
		LogicalChannelIdentity_t	*splitSecondaryPath_r16	/* OPTIONAL */;
		struct PDCP_Config__moreThanTwoRLC_DRB_r16__duplicationState_r16 {
	...
	struct PDCP_Config__ethernetHeaderCompression_r16 {
		PDCP_Config__ethernetHeaderCompression_r16_PR present;
		union PDCP_Config__ethernetHeaderCompression_r16_u {
			NULL_t	 release;
...
extern asn_TYPE_member_t asn_MBR_PDCP_Config_1[7];
