...
static asn_TYPE_member_t asn_MBR_measObject_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectUTRA_FDD_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectNR_SL_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectCLI_r16),
