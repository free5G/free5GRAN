...
typedef enum RACH_ConfigCommon__prach_RootSequenceIndex_r16_PR {
	RACH_ConfigCommon__prach_RootSequenceIndex_r16_PR_NOTHING,	/* No components present */
	RACH_ConfigCommon__prach_RootSequenceIndex_r16_PR_l571,
	RACH_ConfigCommon__prach_RootSequenceIndex_r16_PR_l1151
} RACH_ConfigCommon__prach_RootSequenceIndex_r16_PR;
...
typedef struct RACH_ConfigCommon {
	 ...
	 */
	struct RACH_ConfigCommon__ra_PrioritizationForAccessIdentity_r16 {
	...
	struct RACH_ConfigCommon__prach_RootSequenceIndex_r16 {
		RACH_ConfigCommon__prach_RootSequenceIndex_r16_PR present;
		union RACH_ConfigCommon__prach_RootSequenceIndex_r16_u {
			long	 l571;
			long	 l1151;
		} choice;
...
extern asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_1[13];
