...
static asn_oer_constraints_t asn_OER_type_measResultListCBR_NR_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_measResultListCBR_NR_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_measResultListCBR_NR_r16_2 = {
	...
	{ &asn_OER_type_measResultListCBR_NR_r16_constr_2, &asn_PER_type_measResultListCBR_NR_r16_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_MeasResultNR_SL_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultNR_SL_r16, measResultListCBR_NR_r16),
		...
		0,
		{ &asn_OER_memb_measResultListCBR_NR_r16_constr_2, &asn_PER_memb_measResultListCBR_NR_r16_constr_2,  memb_measResultListCBR_NR_r16_constraint_1 },
		0, 0, /* No default value */
		"measResultListCBR-NR-r16"
		},
};
