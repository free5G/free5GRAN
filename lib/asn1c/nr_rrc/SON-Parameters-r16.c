 ...
 */
static asn_oer_constraints_t asn_OER_type_rach_Report_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_rach_Report_r16_2 = {
	...
	{ &asn_OER_type_rach_Report_r16_constr_2, &asn_PER_type_rach_Report_r16_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_rach_Report_r16_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_SON_Parameters_r16_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SON_Parameters_r16, rach_Report_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const int asn_MAP_SON_Parameters_r16_oms_1[] = { 0 };
