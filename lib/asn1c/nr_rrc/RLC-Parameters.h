...
typedef enum RLC_Parameters__extendedT_PollRetransmit_r16 {
	RLC_Parameters__extendedT_PollRetransmit_r16_supported	= 0
} e_RLC_Parameters__extendedT_PollRetransmit_r16;
typedef enum RLC_Parameters__extendedT_StatusProhibit_r16 {
	RLC_Parameters__extendedT_StatusProhibit_r16_supported	= 0
} e_RLC_Parameters__extendedT_StatusProhibit_r16;
...
/* extern asn_TYPE_descriptor_t asn_DEF_extendedT_PollRetransmit_r16_9;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_extendedT_StatusProhibit_r16_11;	// (Use -fall-defs-global to expose) */
