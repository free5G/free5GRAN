...
static asn_oer_constraints_t asn_OER_type_sl_ConfiguredGrantConfigToReleaseList_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_type_sl_ConfiguredGrantConfigToAddModList_r16_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_sl_ConfiguredGrantConfigToReleaseList_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_sl_ConfiguredGrantConfigToAddModList_r16_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_sl_ConfiguredGrantConfigToReleaseList_r16_2 = {
	...
	{ &asn_OER_type_sl_ConfiguredGrantConfigToReleaseList_r16_constr_2, &asn_PER_type_sl_ConfiguredGrantConfigToReleaseList_r16_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sl_ConfiguredGrantConfigToAddModList_r16_4 = {
	...
	{ &asn_OER_type_sl_ConfiguredGrantConfigToAddModList_r16_constr_4, &asn_PER_type_sl_ConfiguredGrantConfigToAddModList_r16_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SL_ConfiguredGrantConfigList_r16_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_ConfiguredGrantConfigList_r16, sl_ConfiguredGrantConfigToReleaseList_r16),
		...
		0,
		{ &asn_OER_memb_sl_ConfiguredGrantConfigToReleaseList_r16_constr_2, &asn_PER_memb_sl_ConfiguredGrantConfigToReleaseList_r16_constr_2,  memb_sl_ConfiguredGrantConfigToReleaseList_r16_constraint_1 },
		0, 0, /* No default value */
		"sl-ConfiguredGrantConfigToReleaseList-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct SL_ConfiguredGrantConfigList_r16, sl_ConfiguredGrantConfigToAddModList_r16),
		...
		0,
		{ &asn_OER_memb_sl_ConfiguredGrantConfigToAddModList_r16_constr_4, &asn_PER_memb_sl_ConfiguredGrantConfigToAddModList_r16_constr_4,  memb_sl_ConfiguredGrantConfigToAddModList_r16_constraint_1 },
		0, 0, /* No default value */
		"sl-ConfiguredGrantConfigToAddModList-r16"
		},
};
