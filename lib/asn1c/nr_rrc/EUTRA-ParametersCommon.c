...
static asn_oer_constraints_t asn_OER_type_nr_HO_ToEN_DC_r16_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_nr_HO_ToEN_DC_r16_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_nr_HO_ToEN_DC_r16_value2enum_12[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_nr_HO_ToEN_DC_r16_enum2value_12[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_nr_HO_ToEN_DC_r16_specs_12 = {
	asn_MAP_nr_HO_ToEN_DC_r16_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_nr_HO_ToEN_DC_r16_enum2value_12,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_nr_HO_ToEN_DC_r16_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nr_HO_ToEN_DC_r16_12 = {
	"nr-HO-ToEN-DC-r16",
	"nr-HO-ToEN-DC-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_nr_HO_ToEN_DC_r16_tags_12,
	sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_12)
		/sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_12[0]) - 1, /* 1 */
	asn_DEF_nr_HO_ToEN_DC_r16_tags_12,	/* Same as above */
	sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_12)
		/sizeof(asn_DEF_nr_HO_ToEN_DC_r16_tags_12[0]), /* 2 */
	{ &asn_OER_type_nr_HO_ToEN_DC_r16_constr_12, &asn_PER_type_nr_HO_ToEN_DC_r16_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_nr_HO_ToEN_DC_r16_specs_12	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_EUTRA_ParametersCommon_1[] = {
	{ ATF_POINTER, 6, offsetof(struct EUTRA_ParametersCommon, mfbi_EUTRA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_ParametersCommon, modifiedMPR_BehaviorEUTRA),
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_ParametersCommon, multiNS_Pmax_EUTRA),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_ParametersCommon, rs_SINR_MeasEUTRA),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_ParametersCommon, ne_DC),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ne_DC_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_ParametersCommon, nr_HO_ToEN_DC_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_nr_HO_ToEN_DC_r16_12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"nr-HO-ToEN-DC-r16"
...
static const int asn_MAP_EUTRA_ParametersCommon_oms_1[] = { 0, 1, 2, 3, 4, 5 };
