...
static asn_TYPE_member_t asn_MBR_criticalExtensionsFuture_r16_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16, choice.rrcPosSystemInfoRequest_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSystemInfoRequest__criticalExtensions, choice.rrcSystemInfoRequest),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSystemInfoRequest__criticalExtensions, choice.criticalExtensionsFuture_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
