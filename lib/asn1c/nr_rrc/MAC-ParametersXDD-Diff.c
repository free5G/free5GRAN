...
static asn_oer_constraints_t asn_OER_type_secondaryDRX_Group_r16_constr_15 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_secondaryDRX_Group_r16_constr_15 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_secondaryDRX_Group_r16_value2enum_15[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_secondaryDRX_Group_r16_enum2value_15[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_secondaryDRX_Group_r16_specs_15 = {
	asn_MAP_secondaryDRX_Group_r16_value2enum_15,	/* "tag" => N; sorted by tag */
	asn_MAP_secondaryDRX_Group_r16_enum2value_15,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_secondaryDRX_Group_r16_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_secondaryDRX_Group_r16_15 = {
	"secondaryDRX-Group-r16",
	"secondaryDRX-Group-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_secondaryDRX_Group_r16_tags_15,
	sizeof(asn_DEF_secondaryDRX_Group_r16_tags_15)
		/sizeof(asn_DEF_secondaryDRX_Group_r16_tags_15[0]) - 1, /* 1 */
	asn_DEF_secondaryDRX_Group_r16_tags_15,	/* Same as above */
	sizeof(asn_DEF_secondaryDRX_Group_r16_tags_15)
		/sizeof(asn_DEF_secondaryDRX_Group_r16_tags_15[0]), /* 2 */
	{ &asn_OER_type_secondaryDRX_Group_r16_constr_15, &asn_PER_type_secondaryDRX_Group_r16_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_secondaryDRX_Group_r16_specs_15	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_MAC_ParametersXDD_Diff_1[] = {
	{ ATF_POINTER, 7, offsetof(struct MAC_ParametersXDD_Diff, skipUplinkTxDynamic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 6, offsetof(struct MAC_ParametersXDD_Diff, logicalChannelSR_DelayTimer),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct MAC_ParametersXDD_Diff, longDRX_Cycle),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct MAC_ParametersXDD_Diff, shortDRX_Cycle),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MAC_ParametersXDD_Diff, multipleSR_Configurations),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MAC_ParametersXDD_Diff, multipleConfiguredGrants),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_ParametersXDD_Diff, secondaryDRX_Group_r16),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_secondaryDRX_Group_r16_15,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"secondaryDRX-Group-r16"
...
static const int asn_MAP_MAC_ParametersXDD_Diff_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
