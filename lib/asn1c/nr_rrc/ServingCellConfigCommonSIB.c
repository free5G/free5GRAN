...
static asn_oer_constraints_t asn_OER_type_channelAccessMode_r16_constr_22 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_channelAccessMode_r16_constr_22 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_discoveryBurstWindowLength_r16_constr_25 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_discoveryBurstWindowLength_r16_constr_25 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  5 }	/* (0..5) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_channelAccessMode_r16_22[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommonSIB__channelAccessMode_r16, choice.dynamic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommonSIB__channelAccessMode_r16, choice.semiStatic),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_channelAccessMode_r16_tag2el_22[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dynamic */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* semiStatic */
};
static asn_CHOICE_specifics_t asn_SPC_channelAccessMode_r16_specs_22 = {
	sizeof(struct ServingCellConfigCommonSIB__channelAccessMode_r16),
	offsetof(struct ServingCellConfigCommonSIB__channelAccessMode_r16, _asn_ctx),
	offsetof(struct ServingCellConfigCommonSIB__channelAccessMode_r16, present),
	sizeof(((struct ServingCellConfigCommonSIB__channelAccessMode_r16 *)0)->present),
	asn_MAP_channelAccessMode_r16_tag2el_22,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_channelAccessMode_r16_22 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_channelAccessMode_r16_constr_22, &asn_PER_type_channelAccessMode_r16_constr_22, CHOICE_constraint },
	asn_MBR_channelAccessMode_r16_22,
	2,	/* Elements count */
	&asn_SPC_channelAccessMode_r16_specs_22	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_discoveryBurstWindowLength_r16_value2enum_25[] = {
	{ 0,	7,	"ms0dot5" },
	{ 1,	3,	"ms1" },
	{ 2,	3,	"ms2" },
	{ 3,	3,	"ms3" },
...
static const unsigned int asn_MAP_discoveryBurstWindowLength_r16_enum2value_25[] = {
	0,	/* ms0dot5(0) */
	1,	/* ms1(1) */
	2,	/* ms2(2) */
	3,	/* ms3(3) */
...
static const asn_INTEGER_specifics_t asn_SPC_discoveryBurstWindowLength_r16_specs_25 = {
	asn_MAP_discoveryBurstWindowLength_r16_value2enum_25,	/* "tag" => N; sorted by tag */
	asn_MAP_discoveryBurstWindowLength_r16_enum2value_25,	/* N => "tag"; sorted by N */
	6,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_discoveryBurstWindowLength_r16_tags_25[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_discoveryBurstWindowLength_r16_25 = {
	"discoveryBurstWindowLength-r16",
	"discoveryBurstWindowLength-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_discoveryBurstWindowLength_r16_tags_25,
	sizeof(asn_DEF_discoveryBurstWindowLength_r16_tags_25)
		/sizeof(asn_DEF_discoveryBurstWindowLength_r16_tags_25[0]) - 1, /* 1 */
	asn_DEF_discoveryBurstWindowLength_r16_tags_25,	/* Same as above */
	sizeof(asn_DEF_discoveryBurstWindowLength_r16_tags_25)
		/sizeof(asn_DEF_discoveryBurstWindowLength_r16_tags_25[0]), /* 2 */
	{ &asn_OER_type_discoveryBurstWindowLength_r16_constr_25, &asn_PER_type_discoveryBurstWindowLength_r16_constr_25, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_discoveryBurstWindowLength_r16_specs_25	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_ServingCellConfigCommonSIB_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct ServingCellConfigCommonSIB, channelAccessMode_r16),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_channelAccessMode_r16_22,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"channelAccessMode-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct ServingCellConfigCommonSIB, discoveryBurstWindowLength_r16),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_discoveryBurstWindowLength_r16_25,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"discoveryBurstWindowLength-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct ServingCellConfigCommonSIB, highSpeedConfig_r16),
...
static const int asn_MAP_ServingCellConfigCommonSIB_oms_1[] = { 1, 2, 3, 6, 8, 9, 10 };
