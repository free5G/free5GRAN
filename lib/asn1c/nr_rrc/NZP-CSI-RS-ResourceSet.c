...
static int
memb_aperiodicTriggeringOffset_r16_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_aperiodicTriggeringOffset_r16_constr_12 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
static asn_per_constraints_t asn_PER_memb_aperiodicTriggeringOffset_r16_constr_12 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_NZP_CSI_RS_ResourceSet_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct NZP_CSI_RS_ResourceSet, repetition),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct NZP_CSI_RS_ResourceSet, aperiodicTriggeringOffset),
	...
	{ ATF_POINTER, 2, offsetof(struct NZP_CSI_RS_ResourceSet, trs_Info),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_trs_Info_9,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NZP_CSI_RS_ResourceSet, aperiodicTriggeringOffset_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_aperiodicTriggeringOffset_r16_constr_12, &asn_PER_memb_aperiodicTriggeringOffset_r16_constr_12,  memb_aperiodicTriggeringOffset_r16_constraint_1 },
		0, 0, /* No default value */
		"aperiodicTriggeringOffset-r16"
		},
};
static const int asn_MAP_NZP_CSI_RS_ResourceSet_oms_1[] = { 2, 3, 4, 5 };
