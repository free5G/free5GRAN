...
asn_TYPE_member_t asn_MBR_ReconfigurationWithSync_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct ReconfigurationWithSync, rach_ConfigDedicated),
	...
	{ ATF_POINTER, 2, offsetof(struct ReconfigurationWithSync, smtc),
	...
	{ ATF_POINTER, 1, offsetof(struct ReconfigurationWithSync, daps_UplinkPowerConfig_r16),
...
static const int asn_MAP_ReconfigurationWithSync_oms_1[] = { 0, 3, 4, 5 };
