...
asn_TYPE_member_t asn_MBR_RRCSystemInfoRequest_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSystemInfoRequest_IEs, requested_SI_List),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSystemInfoRequest_IEs, spare),
...
static const ber_tlv_tag_t asn_DEF_RRCSystemInfoRequest_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRCSystemInfoRequest_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* requested-SI-List */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* spare */
};
asn_SEQUENCE_specifics_t asn_SPC_RRCSystemInfoRequest_IEs_specs_1 = {
	sizeof(struct RRCSystemInfoRequest_IEs),
	offsetof(struct RRCSystemInfoRequest_IEs, _asn_ctx),
	asn_MAP_RRCSystemInfoRequest_IEs_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_RRCSystemInfoRequest_IEs = {
	"RRCSystemInfoRequest-IEs",
	"RRCSystemInfoRequest-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_RRCSystemInfoRequest_IEs_tags_1,
	sizeof(asn_DEF_RRCSystemInfoRequest_IEs_tags_1)
		/sizeof(asn_DEF_RRCSystemInfoRequest_IEs_tags_1[0]), /* 1 */
	asn_DEF_RRCSystemInfoRequest_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_RRCSystemInfoRequest_IEs_tags_1)
		/sizeof(asn_DEF_RRCSystemInfoRequest_IEs_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_RRCSystemInfoRequest_IEs_1,
	2,	/* Elements count */
	&asn_SPC_RRCSystemInfoRequest_IEs_specs_1	/* Additional specs */
};
