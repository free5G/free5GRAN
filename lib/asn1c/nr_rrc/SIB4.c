...
asn_TYPE_member_t asn_MBR_SIB4_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SIB4, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 1, offsetof(struct SIB4, interFreqCarrierFreqList_v1610),
...
static const int asn_MAP_SIB4_oms_1[] = { 1, 2 };
