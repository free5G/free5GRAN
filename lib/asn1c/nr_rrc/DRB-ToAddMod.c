...
static asn_oer_constraints_t asn_OER_type_daps_Config_r16_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_daps_Config_r16_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_daps_Config_r16_value2enum_12[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_daps_Config_r16_enum2value_12[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_daps_Config_r16_specs_12 = {
	asn_MAP_daps_Config_r16_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_daps_Config_r16_enum2value_12,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_daps_Config_r16_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_daps_Config_r16_12 = {
	"daps-Config-r16",
	"daps-Config-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_daps_Config_r16_tags_12,
	sizeof(asn_DEF_daps_Config_r16_tags_12)
		/sizeof(asn_DEF_daps_Config_r16_tags_12[0]) - 1, /* 1 */
	asn_DEF_daps_Config_r16_tags_12,	/* Same as above */
	sizeof(asn_DEF_daps_Config_r16_tags_12)
		/sizeof(asn_DEF_daps_Config_r16_tags_12[0]), /* 2 */
	{ &asn_OER_type_daps_Config_r16_constr_12, &asn_PER_type_daps_Config_r16_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_daps_Config_r16_specs_12	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_DRB_ToAddMod_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct DRB_ToAddMod, reestablishPDCP),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct DRB_ToAddMod, recoverPDCP),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct DRB_ToAddMod, pdcp_Config),
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod, daps_Config_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_daps_Config_r16_12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"daps-Config-r16"
