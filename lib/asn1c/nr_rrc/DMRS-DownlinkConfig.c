...
static asn_oer_constraints_t asn_OER_type_dmrs_Downlink_r16_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_dmrs_Downlink_r16_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_phaseTrackingRS_12[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DMRS_DownlinkConfig__phaseTrackingRS, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static const asn_INTEGER_enum_map_t asn_MAP_dmrs_Downlink_r16_value2enum_16[] = {
	{ 0,	7,	"enabled" }
};
static const unsigned int asn_MAP_dmrs_Downlink_r16_enum2value_16[] = {
	0	/* enabled(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dmrs_Downlink_r16_specs_16 = {
	asn_MAP_dmrs_Downlink_r16_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_dmrs_Downlink_r16_enum2value_16,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_dmrs_Downlink_r16_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dmrs_Downlink_r16_16 = {
	"dmrs-Downlink-r16",
	"dmrs-Downlink-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_dmrs_Downlink_r16_tags_16,
	sizeof(asn_DEF_dmrs_Downlink_r16_tags_16)
		/sizeof(asn_DEF_dmrs_Downlink_r16_tags_16[0]) - 1, /* 1 */
	asn_DEF_dmrs_Downlink_r16_tags_16,	/* Same as above */
	sizeof(asn_DEF_dmrs_Downlink_r16_tags_16)
		/sizeof(asn_DEF_dmrs_Downlink_r16_tags_16[0]), /* 2 */
	{ &asn_OER_type_dmrs_Downlink_r16_constr_16, &asn_PER_type_dmrs_Downlink_r16_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dmrs_Downlink_r16_specs_16	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_DMRS_DownlinkConfig_1[] = {
	{ ATF_POINTER, 7, offsetof(struct DMRS_DownlinkConfig, dmrs_Type),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dmrs_Type_2,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct DMRS_DownlinkConfig, dmrs_AdditionalPosition),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct DMRS_DownlinkConfig, maxLength),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_maxLength_8,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct DMRS_DownlinkConfig, scramblingID0),
	...
	{ ATF_POINTER, 3, offsetof(struct DMRS_DownlinkConfig, scramblingID1),
	...
	{ ATF_POINTER, 2, offsetof(struct DMRS_DownlinkConfig, phaseTrackingRS),
	...
	{ ATF_POINTER, 1, offsetof(struct DMRS_DownlinkConfig, dmrs_Downlink_r16),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dmrs_Downlink_r16_16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"dmrs-Downlink-r16"
...
static const int asn_MAP_DMRS_DownlinkConfig_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
