...
static int
memb_nr_SCG_Response_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_nr_SCG_Response_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
static asn_per_constraints_t asn_PER_memb_nr_SCG_Response_constr_3 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_scg_Response_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReconfigurationComplete_v1560_IEs__scg_Response, choice.nr_SCG_Response),
		...
		0,
		{ &asn_OER_memb_nr_SCG_Response_constr_3, &asn_PER_memb_nr_SCG_Response_constr_3,  memb_nr_SCG_Response_constraint_2 },
