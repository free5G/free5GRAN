...
static asn_oer_constraints_t asn_OER_type_enableConfiguredUL_r16_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_enableConfiguredUL_r16_constr_9 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_enableConfiguredUL_r16_value2enum_9[] = {
	{ 0,	7,	"enabled" }
};
static const unsigned int asn_MAP_enableConfiguredUL_r16_enum2value_9[] = {
	0	/* enabled(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_enableConfiguredUL_r16_specs_9 = {
	asn_MAP_enableConfiguredUL_r16_value2enum_9,	/* "tag" => N; sorted by tag */
	asn_MAP_enableConfiguredUL_r16_enum2value_9,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_enableConfiguredUL_r16_tags_9[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_enableConfiguredUL_r16_9 = {
	"enableConfiguredUL-r16",
	"enableConfiguredUL-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_enableConfiguredUL_r16_tags_9,
	sizeof(asn_DEF_enableConfiguredUL_r16_tags_9)
		/sizeof(asn_DEF_enableConfiguredUL_r16_tags_9[0]) - 1, /* 1 */
	asn_DEF_enableConfiguredUL_r16_tags_9,	/* Same as above */
	sizeof(asn_DEF_enableConfiguredUL_r16_tags_9)
		/sizeof(asn_DEF_enableConfiguredUL_r16_tags_9[0]), /* 2 */
	{ &asn_OER_type_enableConfiguredUL_r16_constr_9, &asn_PER_type_enableConfiguredUL_r16_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_enableConfiguredUL_r16_specs_9	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SlotFormatCombinationsPerCell_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SlotFormatCombinationsPerCell, subcarrierSpacing2),
	...
	{ ATF_POINTER, 3, offsetof(struct SlotFormatCombinationsPerCell, slotFormatCombinations),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SlotFormatCombinationsPerCell, positionInDCI),
	...
	{ ATF_POINTER, 1, offsetof(struct SlotFormatCombinationsPerCell, enableConfiguredUL_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_enableConfiguredUL_r16_9,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"enableConfiguredUL-r16"
...
static const int asn_MAP_SlotFormatCombinationsPerCell_oms_1[] = { 2, 3, 4, 5 };
