...
asn_TYPE_member_t asn_MBR_IntraFreqNeighCellInfo_v1610_1[] = {
	{ ATF_POINTER, 1, offsetof(struct IntraFreqNeighCellInfo_v1610, ssb_PositionQCL_r16),
...
static const int asn_MAP_IntraFreqNeighCellInfo_v1610_oms_1[] = { 0 };
...
asn_SEQUENCE_specifics_t asn_SPC_IntraFreqNeighCellInfo_v1610_specs_1 = {
	...
	asn_MAP_IntraFreqNeighCellInfo_v1610_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
