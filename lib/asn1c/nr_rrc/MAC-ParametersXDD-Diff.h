...
typedef enum MAC_ParametersXDD_Diff__secondaryDRX_Group_r16 {
	MAC_ParametersXDD_Diff__secondaryDRX_Group_r16_supported	= 0
} e_MAC_ParametersXDD_Diff__secondaryDRX_Group_r16;
...
/* extern asn_TYPE_descriptor_t asn_DEF_secondaryDRX_Group_r16_15;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_MAC_ParametersXDD_Diff_1[7];
