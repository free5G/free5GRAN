...
static int
memb_maxPayloadSize_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_maxPayloadSize_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (4..256) */,
	-1};
static asn_per_constraints_t asn_PER_memb_maxPayloadSize_constr_5 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PUCCH_ResourceSet_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PUCCH_ResourceSet, maxPayloadSize),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxPayloadSize_constr_5, &asn_PER_memb_maxPayloadSize_constr_5,  memb_maxPayloadSize_constraint_1 },
		0, 0, /* No default value */
		"maxPayloadSize"
		},
};
