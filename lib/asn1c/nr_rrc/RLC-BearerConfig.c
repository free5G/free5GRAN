...
asn_TYPE_member_t asn_MBR_RLC_BearerConfig_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct RLC_BearerConfig, servedRadioBearer),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 4, offsetof(struct RLC_BearerConfig, reestablishRLC),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct RLC_BearerConfig, rlc_Config),
	...
	{ ATF_POINTER, 2, offsetof(struct RLC_BearerConfig, mac_LogicalChannelConfig),
	...
	{ ATF_POINTER, 1, offsetof(struct RLC_BearerConfig, rlc_Config_v1610),
...
static const int asn_MAP_RLC_BearerConfig_oms_1[] = { 1, 2, 3, 4, 5 };
