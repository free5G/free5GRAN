...
static int
memb_sl5120_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_sl10240_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_sl40960_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_sl81920_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_sl5120_constr_19 CC_NOTUSED = {
	{ 2, 1 }	/* (0..5119) */,
	-1};
static asn_per_constraints_t asn_PER_memb_sl5120_constr_19 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 13,  13,  0,  5119 }	/* (0..5119) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_sl10240_constr_20 CC_NOTUSED = {
	{ 2, 1 }	/* (0..10239) */,
	-1};
static asn_per_constraints_t asn_PER_memb_sl10240_constr_20 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 14,  14,  0,  10239 }	/* (0..10239) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_sl40960_constr_21 CC_NOTUSED = {
	{ 2, 1 }	/* (0..40959) */,
	-1};
static asn_per_constraints_t asn_PER_memb_sl40960_constr_21 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16,  0,  40959 }	/* (0..40959) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_sl81920_constr_22 CC_NOTUSED = {
	{ 4, 1 }	/* (0..81919) */,
	-1};
static asn_per_constraints_t asn_PER_memb_sl81920_constr_22 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 17, -1,  0,  81919 }	/* (0..81919) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_SRS_PeriodicityAndOffset_r16_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_SRS_PeriodicityAndOffset_r16_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  5,  5,  0,  20 }	/* (0..20,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SRS_PeriodicityAndOffset_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl8),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl10),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl20),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl32),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl40),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl64),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl80),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl160),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl320),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl640),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl1280),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl2560),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl5120),
		(ASN_TAG_CLASS_CONTEXT | (17 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sl5120_constr_19, &asn_PER_memb_sl5120_constr_19,  memb_sl5120_constraint_1 },
		0, 0, /* No default value */
		"sl5120"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl10240),
		(ASN_TAG_CLASS_CONTEXT | (18 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sl10240_constr_20, &asn_PER_memb_sl10240_constr_20,  memb_sl10240_constraint_1 },
		0, 0, /* No default value */
		"sl10240"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl40960),
		(ASN_TAG_CLASS_CONTEXT | (19 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sl40960_constr_21, &asn_PER_memb_sl40960_constr_21,  memb_sl40960_constraint_1 },
		0, 0, /* No default value */
		"sl40960"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_PeriodicityAndOffset_r16, choice.sl81920),
		(ASN_TAG_CLASS_CONTEXT | (20 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sl81920_constr_22, &asn_PER_memb_sl81920_constr_22,  memb_sl81920_constraint_1 },
		0, 0, /* No default value */
		"sl81920"
		},
};
static const asn_TYPE_tag2member_t asn_MAP_SRS_PeriodicityAndOffset_r16_tag2el_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_SRS_PeriodicityAndOffset_r16_specs_1 = {
	sizeof(struct SRS_PeriodicityAndOffset_r16),
	offsetof(struct SRS_PeriodicityAndOffset_r16, _asn_ctx),
	offsetof(struct SRS_PeriodicityAndOffset_r16, present),
	sizeof(((struct SRS_PeriodicityAndOffset_r16 *)0)->present),
	asn_MAP_SRS_PeriodicityAndOffset_r16_tag2el_1,
	21,	/* Count of tags in the map */
	0, 0,
	21	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_SRS_PeriodicityAndOffset_r16 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_SRS_PeriodicityAndOffset_r16_constr_1, &asn_PER_type_SRS_PeriodicityAndOffset_r16_constr_1, CHOICE_constraint },
	asn_MBR_SRS_PeriodicityAndOffset_r16_1,
	21,	/* Elements count */
	&asn_SPC_SRS_PeriodicityAndOffset_r16_specs_1	/* Additional specs */
};
