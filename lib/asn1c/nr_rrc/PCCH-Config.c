...
static int
memb_nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16_constr_31 CC_NOTUSED = {
	{ 1, 1 }	/* (2..4) */,
	-1};
static asn_per_constraints_t asn_PER_memb_nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16_constr_31 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PCCH_Config_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PCCH_Config, firstPDCCH_MonitoringOccasionOfPO),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct PCCH_Config, nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16_constr_31, &asn_PER_memb_nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16_constr_31,  memb_nrofPDCCH_MonitoringOccasionPerSSB_InPO_r16_constraint_1 },
		0, 0, /* No default value */
		"nrofPDCCH-MonitoringOccasionPerSSB-InPO-r16"
		},
};
static const int asn_MAP_PCCH_Config_oms_1[] = { 3, 4 };
