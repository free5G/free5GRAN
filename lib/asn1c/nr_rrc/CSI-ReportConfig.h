...
typedef enum CSI_ReportConfig__reportQuantity_r16_PR {
	CSI_ReportConfig__reportQuantity_r16_PR_NOTHING,	/* No components present */
	CSI_ReportConfig__reportQuantity_r16_PR_cri_SINR_r16,
	CSI_ReportConfig__reportQuantity_r16_PR_ssb_Index_SINR_r16
} CSI_ReportConfig__reportQuantity_r16_PR;
...
typedef struct CSI_ReportConfig {
	...
	struct CSI_ReportConfig__semiPersistentOnPUSCH_v1610 {
		struct CSI_ReportConfig__semiPersistentOnPUSCH_v1610__reportSlotOffsetListDCI_0_2_r16 {
			A_SEQUENCE_OF(long) list;
			
			/* Context for parsing across buffer boundaries */
			asn_struct_ctx_t _asn_ctx;
		} *reportSlotOffsetListDCI_0_2_r16;
		struct CSI_ReportConfig__semiPersistentOnPUSCH_v1610__reportSlotOffsetListDCI_0_1_r16 {
			A_SEQUENCE_OF(long) list;
	...
	struct CSI_ReportConfig__aperiodic_v1610 {
		struct CSI_ReportConfig__aperiodic_v1610__reportSlotOffsetListDCI_0_2_r16 {
			A_SEQUENCE_OF(long) list;
			
			/* Context for parsing across buffer boundaries */
			asn_struct_ctx_t _asn_ctx;
		} *reportSlotOffsetListDCI_0_2_r16;
		struct CSI_ReportConfig__aperiodic_v1610__reportSlotOffsetListDCI_0_1_r16 {
			A_SEQUENCE_OF(long) list;
	...
	struct CSI_ReportConfig__reportQuantity_r16 {
		CSI_ReportConfig__reportQuantity_r16_PR present;
		union CSI_ReportConfig__reportQuantity_r16_u {
			NULL_t	 cri_SINR_r16;
