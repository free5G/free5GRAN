...
typedef enum MobilityFromNRCommand_IEs__targetRAT_Type {
	...
	MobilityFromNRCommand_IEs__targetRAT_Type_utra_fdd_v1610	= 1,
...
struct MobilityFromNRCommand_v1610_IEs;
...
typedef struct MobilityFromNRCommand_IEs {
	...
	struct MobilityFromNRCommand_v1610_IEs	*nonCriticalExtension	/* OPTIONAL */;
