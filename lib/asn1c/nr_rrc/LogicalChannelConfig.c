...
static int
memb_allowedCG_List_r16_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
 ...
 */
static int
memb_channelAccessPriority_r16_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_type_allowedCG_List_r16_constr_67 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..31)) */};
static asn_per_constraints_t asn_PER_type_allowedCG_List_r16_constr_67 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  0,  31 }	/* (SIZE(0..31)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_allowedPHY_PriorityIndex_r16_constr_69 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_allowedPHY_PriorityIndex_r16_constr_69 CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_allowedCG_List_r16_constr_67 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..31)) */};
static asn_per_constraints_t asn_PER_memb_allowedCG_List_r16_constr_67 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  0,  31 }	/* (SIZE(0..31)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_bitRateMultiplier_r16_constr_74 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_bitRateMultiplier_r16_constr_74 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_channelAccessPriority_r16_constr_73 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
static asn_per_constraints_t asn_PER_memb_channelAccessPriority_r16_constr_73 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_allowedCG_List_r16_67[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (2 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_allowedCG_List_r16_tags_67[] = {
	(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_allowedCG_List_r16_specs_67 = {
	sizeof(struct LogicalChannelConfig__ul_SpecificParameters__allowedCG_List_r16),
	offsetof(struct LogicalChannelConfig__ul_SpecificParameters__allowedCG_List_r16, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_allowedCG_List_r16_67 = {
	"allowedCG-List-r16",
	"allowedCG-List-r16",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_allowedCG_List_r16_tags_67,
	sizeof(asn_DEF_allowedCG_List_r16_tags_67)
		/sizeof(asn_DEF_allowedCG_List_r16_tags_67[0]) - 1, /* 1 */
	asn_DEF_allowedCG_List_r16_tags_67,	/* Same as above */
	sizeof(asn_DEF_allowedCG_List_r16_tags_67)
		/sizeof(asn_DEF_allowedCG_List_r16_tags_67[0]), /* 2 */
	{ &asn_OER_type_allowedCG_List_r16_constr_67, &asn_PER_type_allowedCG_List_r16_constr_67, SEQUENCE_OF_constraint },
	asn_MBR_allowedCG_List_r16_67,
	1,	/* Single element */
	&asn_SPC_allowedCG_List_r16_specs_67	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_allowedPHY_PriorityIndex_r16_value2enum_69[] = {
	{ 0,	2,	"p0" },
	{ 1,	2,	"p1" }
};
static const unsigned int asn_MAP_allowedPHY_PriorityIndex_r16_enum2value_69[] = {
	0,	/* p0(0) */
	1	/* p1(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_allowedPHY_PriorityIndex_r16_specs_69 = {
	asn_MAP_allowedPHY_PriorityIndex_r16_value2enum_69,	/* "tag" => N; sorted by tag */
	asn_MAP_allowedPHY_PriorityIndex_r16_enum2value_69,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_allowedPHY_PriorityIndex_r16_tags_69[] = {
	(ASN_TAG_CLASS_CONTEXT | (13 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_allowedPHY_PriorityIndex_r16_69 = {
	"allowedPHY-PriorityIndex-r16",
	"allowedPHY-PriorityIndex-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_allowedPHY_PriorityIndex_r16_tags_69,
	sizeof(asn_DEF_allowedPHY_PriorityIndex_r16_tags_69)
		/sizeof(asn_DEF_allowedPHY_PriorityIndex_r16_tags_69[0]) - 1, /* 1 */
	asn_DEF_allowedPHY_PriorityIndex_r16_tags_69,	/* Same as above */
	sizeof(asn_DEF_allowedPHY_PriorityIndex_r16_tags_69)
		/sizeof(asn_DEF_allowedPHY_PriorityIndex_r16_tags_69[0]), /* 2 */
	{ &asn_OER_type_allowedPHY_PriorityIndex_r16_constr_69, &asn_PER_type_allowedPHY_PriorityIndex_r16_constr_69, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_allowedPHY_PriorityIndex_r16_specs_69	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_ul_SpecificParameters_2[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct LogicalChannelConfig__ul_SpecificParameters, bitRateQueryProhibitTimer),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct LogicalChannelConfig__ul_SpecificParameters, allowedCG_List_r16),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		0,
		&asn_DEF_allowedCG_List_r16_67,
		0,
		{ &asn_OER_memb_allowedCG_List_r16_constr_67, &asn_PER_memb_allowedCG_List_r16_constr_67,  memb_allowedCG_List_r16_constraint_2 },
		0, 0, /* No default value */
		"allowedCG-List-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct LogicalChannelConfig__ul_SpecificParameters, allowedPHY_PriorityIndex_r16),
		(ASN_TAG_CLASS_CONTEXT | (13 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_allowedPHY_PriorityIndex_r16_69,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"allowedPHY-PriorityIndex-r16"
...
static const int asn_MAP_ul_SpecificParameters_oms_2[] = { 3, 4, 5, 6, 7, 8, 11, 12, 13 };
...
static const asn_INTEGER_enum_map_t asn_MAP_bitRateMultiplier_r16_value2enum_74[] = {
	{ 0,	3,	"x40" },
	{ 1,	3,	"x70" },
	{ 2,	4,	"x100" },
	{ 3,	4,	"x200" }
};
static const unsigned int asn_MAP_bitRateMultiplier_r16_enum2value_74[] = {
	2,	/* x100(2) */
	3,	/* x200(3) */
	0,	/* x40(0) */
	1	/* x70(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_bitRateMultiplier_r16_specs_74 = {
	asn_MAP_bitRateMultiplier_r16_value2enum_74,	/* "tag" => N; sorted by tag */
	asn_MAP_bitRateMultiplier_r16_enum2value_74,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_bitRateMultiplier_r16_tags_74[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_bitRateMultiplier_r16_74 = {
	"bitRateMultiplier-r16",
	"bitRateMultiplier-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_bitRateMultiplier_r16_tags_74,
	sizeof(asn_DEF_bitRateMultiplier_r16_tags_74)
		/sizeof(asn_DEF_bitRateMultiplier_r16_tags_74[0]) - 1, /* 1 */
	asn_DEF_bitRateMultiplier_r16_tags_74,	/* Same as above */
	sizeof(asn_DEF_bitRateMultiplier_r16_tags_74)
		/sizeof(asn_DEF_bitRateMultiplier_r16_tags_74[0]), /* 2 */
	{ &asn_OER_type_bitRateMultiplier_r16_constr_74, &asn_PER_type_bitRateMultiplier_r16_constr_74, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_bitRateMultiplier_r16_specs_74	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_LogicalChannelConfig_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LogicalChannelConfig, channelAccessPriority_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_channelAccessPriority_r16_constr_73, &asn_PER_memb_channelAccessPriority_r16_constr_73,  memb_channelAccessPriority_r16_constraint_1 },
		0, 0, /* No default value */
		"channelAccessPriority-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct LogicalChannelConfig, bitRateMultiplier_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_bitRateMultiplier_r16_74,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"bitRateMultiplier-r16"
