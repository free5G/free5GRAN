 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_idleMeasAvailable_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_nr_SCG_Response_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_type_scg_Response_r16_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_mobilityHistoryAvail_r16_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_mobilityState_r16_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_idleMeasAvailable_r16_2 = {
	...
	{ &asn_OER_type_idleMeasAvailable_r16_constr_2, &asn_PER_type_idleMeasAvailable_r16_constr_2, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_scg_Response_r16_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCResumeComplete_v1610_IEs__scg_Response_r16, choice.nr_SCG_Response),
		...
		0,
		{ &asn_OER_memb_nr_SCG_Response_constr_7, &asn_PER_memb_nr_SCG_Response_constr_7,  memb_nr_SCG_Response_constraint_6 },
...
asn_TYPE_descriptor_t asn_DEF_scg_Response_r16_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_scg_Response_r16_constr_6, &asn_PER_type_scg_Response_r16_constr_6, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_mobilityHistoryAvail_r16_10 = {
	...
	{ &asn_OER_type_mobilityHistoryAvail_r16_constr_10, &asn_PER_type_mobilityHistoryAvail_r16_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_mobilityState_r16_12 = {
	...
	{ &asn_OER_type_mobilityState_r16_constr_12, &asn_PER_type_mobilityState_r16_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mobilityState_r16_specs_12	/* Additional specs */
};

static const ber_tlv_tag_t asn_DEF_nonCriticalExtension_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_18 = {
	sizeof(struct RRCResumeComplete_v1610_IEs__nonCriticalExtension),
	offsetof(struct RRCResumeComplete_v1610_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nonCriticalExtension_18 = {
	"nonCriticalExtension",
	"nonCriticalExtension",
	&asn_OP_SEQUENCE,
	asn_DEF_nonCriticalExtension_tags_18,
	sizeof(asn_DEF_nonCriticalExtension_tags_18)
		/sizeof(asn_DEF_nonCriticalExtension_tags_18[0]) - 1, /* 1 */
	asn_DEF_nonCriticalExtension_tags_18,	/* Same as above */
	sizeof(asn_DEF_nonCriticalExtension_tags_18)
		/sizeof(asn_DEF_nonCriticalExtension_tags_18[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	0, 0,	/* No members */
	&asn_SPC_nonCriticalExtension_specs_18	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RRCResumeComplete_v1610_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RRCResumeComplete_v1610_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_nonCriticalExtension_18,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"nonCriticalExtension"
