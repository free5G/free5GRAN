...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, choice.ueInformationRequest_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, choice.dlInformationTransferMRDC_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, choice.loggedMeasurementConfiguration_r16),
