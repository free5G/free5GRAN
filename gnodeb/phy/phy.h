...
public:
    ...
    void UE_decode_polar_dci(std::vector<int> rate_matched_dci, int K, int N, int E, int polar_decoded_size, int freq_domain_ra_size, int *rnti, bool &validated, free5GRAN::dci_1_0_si_rnti &dci_object);
};
