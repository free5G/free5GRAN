...
public:
    ...
    void UE_decode_polar_dci(vector<complex<float>> pdcch_symbols, int K, int N, int E, int pci,int agg_level, int polar_decoded_size, int freq_domain_ra_size, int *rnti, bool &validated, free5GRAN::dci_1_0_si_rnti &dci_object);
};
