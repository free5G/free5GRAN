...
int main(int argc, char *argv[]) {
    ...
    bool run_with_usrp_10ms = false; /** put 'true' if runing_platform is attached to an USRP */
    ...
    if (free5GRAN::display_variables) {
        for (int symbol = 0; symbol < 4; symbol++) {
            free5GRAN::utils::common_utils::display_complex_float(Test_signal_full_power[symbol],
                                                                  free5GRAN::SIZE_IFFT_SSB + cp_lengths[1],
                                                                  "Test_signal_full_power");
        }
    }
 ...
 */
    ...
    int num_0_to_add =
            1 + (ssb_period - (num_symbols_SSB * Num_samples_per_symbol_SSB * sample_duration)) / sample_duration;
    ...
    BOOST_LOG_TRIVIAL(info)
        << "number of 0 added at the end of USRP (to obtain a precise time interval) = " + std::to_string(num_0_to_add);
    ...
    if (free5GRAN::display_variables) {
        free5GRAN::utils::common_utils::display_complex_float(SSB_signal_time_domain_CP_5ms[0],
                                                              Num_samples_per_symbol_SSB,
                                                              "SSB_5ms symbol 0 = ");
        free5GRAN::utils::common_utils::display_complex_float(SSB_signal_time_domain_CP_5ms[1],
                                                              Num_samples_per_symbol_SSB,
                                                              "SSB_5ms symbol 1 = ");
        free5GRAN::utils::common_utils::display_complex_float(SSB_signal_time_domain_CP_5ms[2],
                                                              Num_samples_per_symbol_SSB,
                                                              "SSB_5ms symbol 2 = ");
        free5GRAN::utils::common_utils::display_complex_float(SSB_signal_time_domain_CP_5ms[3],
                                                              Num_samples_per_symbol_SSB,
                                                              "SSB_5ms symbol 3 = ");
    ...
    int Num_symbols_per_frame = Num_symbols_per_subframe * 10;  //To be replaced by a variable
